...
<nav class="navbar navbar-default">
    <div class="container-fluid">
        <div class="navbar-header">
            ...
            <span class="icon-bar"></span>
            <span class="icon-bar"></span>
            <a href="home.php" class="navbar-brand">Voice</a>
        </div>
        <div class="collapse navbar-collapse">
            ...
            $user_posts="select * from postes where user_id='$user_id'";
            $run_posts=mysqli_query($con,$user_posts);
            $posts=mysql_num_rows($run_posts);
            ?>
            <li><a href='profile.php?<?php echo "u_id=$user_id"?>'></a><?php echo "$first_name";?></li>
            <li><a href='home.php'>Home</a> </li>
            <li><a href='home.php'>Find people</a></li>
            <li><a href="massage.php?u_id=new">Massages</a> </li>
            <?php
            echo "
            <a class='dropdown'>
            ...
            <li>
            <a href='my_post.php?u_id=$user_id'>My posts<span class='badge badge-secondary' >
            $posts
            </span>
            </a>
            </li>
